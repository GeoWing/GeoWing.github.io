...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-122.174378, 37.476821, -122.168743, 37.480020], maxZoom: 27, minZoom: 1, projection: 'EPSG:4326'
    })
});
map.getView().fit([-122.174378, 37.476821, -122.168743, 37.480020], map.getSize());
